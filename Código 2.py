#en esta parte inportamos las librerias que necesitamos que son las que nesecitamos para el parcial
import random
import matplotlib.pyplot as plt
#aqui ponemos los equipos
...
#qui ponemos el menu requiero lo hacemos con opciones
while True:
    # en esta parte es la de el menu
    print("Bienvenido al menú:")
    print("1. Calcular la cantidad de partidos ganados por equipo")
    print("2. Calcular la cantidad de partidos por equipo")
    print("3. Calcular la cantidad de partidos empatados por equipo")
    print("4. Calcular la cantidad de partidos perdidos por equipo")
    print("5. Calcular la cantidad de goles de los equipos visitantes PLUS graficar")
    print("6. Calcular la cantidad de goles de los equipos locales PLUS graficar")
    print("7. Calcular la cantidad de partidos por equipo")
    print("8. Calcular la cantidad total de goles de todos los partidos")
    print("9. Equipo que más goles realizó")
    print("10. Listado de los equipos con sus goles de local y de visitante")
    print("11. Lea por teclado el nombre del equipo y liste los partidos en lo que ha participado y sus marcadores")
    print("12. Equipo que menos goles recibió")
    print("13. Imprimir la tabla de posiciones de mayor a mejor por puntaje")
    print("14. Armar la tabla de posiciones y crear una nueva lista con los puntos por equipo")


    # aqui pedimos las opciones del menu
    opcion = int(input("Por favor, seleccione una opción del menú (1-14): "))

    # en esta parte ya dependiendo de la opcion del usuario ejecutamos lo requerido
    if opcion == 2:
        ...
        for partido in partidos:
            equipos = partido[:2]  # Obtenemos los nombres de los equipos
        ...
        for partido in partidos:
            ...
            # Si el partido fue un empate, aumentamos el contador de empates para ambos equipos
        ...
        # Creamos un gráfico de barras que son nesesarios para dos preguntas del parcial
        ...
        # imprimimos la cantidad de goles para el parcial
        ...
        # Define la cantidad de goles locales
